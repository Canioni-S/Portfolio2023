...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Portfolio de Stéphan Canioni développeur web">
...
<body>
    <div id="mainContainer">
        ...
        <nav id="navBar">
            ...
            <div id="linksContainer" class="navBarBurger">
                ...
                <a href="#contactSection" class="navLink flexCenter" id="contactLink">
                    ...
                    <img src="../Assest/NavbarImg/contactLinkImg.webp" alt="Photo d'un homme tenant un téléphone affichant un contact." class="navLinkImg">
                </a>
        ...
        <!-- HOME SECTION -->
        <div id="homeSection">
            <img id="homeBG" src="/Assest/HomeSectionImg/milky-way-galaxy-night-W=1900.webp" alt="Arrière-plan d'image représentant la voie lactée.">
            ...
            <div id="scrollIconContainer" class="flexCenter">
                <svg id="fingerScroll" version="1.0" xmlns="http://www.w3.org/2000/svg" width="50%" viewBox="0 0 30.000000 34.000000" preserveAspectRatio="xMidYMid meet">
                ...
                <svg id="mouseScroll" version="1.0" xmlns="http://www.w3.org/2000/svg" width="50%" viewBox="0 0 100.000000 100.000000" preserveAspectRatio="xMidYMid meet">
        ...
        <div id="presentationSection" class="flexCenter">
            ...
            <div class="slideshowContainer">
                ...
                <div class="mySlides fade">
                    ...
                    <div class="slideContainer">
                        <div class="frontSlideContainer">
                            <img class="frontSlide" src="../Assest/PresentationSectionImg/constructionSlide.webp" alt="Arrière-plan noir et blanc d'un chantier de construction.">
                        </div>
                        <div class="backSlideContainer">
                            <img class="backSlide" src="../Assest/PresentationSectionImg/citySlide.webp" alt="Arrière-plan noir et blanc d'une ville avec ses gratte-ciel.">
                        </div>
                    </div>
                ...
                <div class="mySlides fade">
                    ...
                    <div class="slideContainer">
                        <div class="frontSlideContainer">
                            <img class="frontSlide" src="../Assest/PresentationSectionImg/backpackSlide.webp" alt="Arrière-plan noir et blanc d'un homme avec un sac à dos de voyage.">
                        </div>
                        <div class="backSlideContainer">
                            <img class="backSlide" src="../Assest/PresentationSectionImg/aroundWorldSlide.webp" alt="Arrière-plan noir et blanc de la terre.">
                        </div>
                    </div>
                    <div class="slideText flexCenter">
                        <p>
                ...
                <div class="mySlides fade">
                    ...
                    <div class="slideContainer">
                        <div class="frontSlideContainer">
                            <img class="frontSlide" src="../Assest/PresentationSectionImg/diplomeSlide.webp" alt="Arrière-plan noir et blanc d'une remise de diplôme.">
                        </div>
                        <div class="backSlideContainer">
                            <img class="backSlide" src="../Assest/PresentationSectionImg/officeSlide.webp" alt="Arrière-plan noir et blanc d'un espace de travail avec des bureaux.">
                        </div>
                    </div>
                    <div class="slideText flexCenter">
                        <p>
                            En revenant en France, j'ai décidé de changer de métier et de me lancer dans le développement web, 
                            un secteur qui m'a toujours attiré et qui est en pleine croissance. Mon diplôme de développeur web bac +2 en poche,
                             je cherche maintenant à me spécialiser dans le back-end et recherche une première expérience professionnelle au travers d'un CDI/CDD,
                              une alternance, ou un stage d'immersion au sein d'une entreprise opérant dans le secteur du développement informatique.
                        </p>
                    </div>
                </div>
                ...
                <div class="flipCard">
                    <div class="flipCardInner">
                        <div class="flipCardFront">
                            <img class="workLinkImg" src="../Assest/flipCardImg/c2cImg.webp" alt="Miniature d'image de la page d'accueil du site présenté.">
                        </div>
